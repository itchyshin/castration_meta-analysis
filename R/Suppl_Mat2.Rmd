...
```{r get species list, message = FALSE, echo = TRUE, eval = TRUE, warning = FALSE}
names(dat)
...
tree$tip.label <- gsub("Perca_fluviatilis", "Lamperta_fluviatilis", tree2$tip.label) #replace with the original name
...
write.tree(tree, file="tree_rotl.tre") #save the tree
