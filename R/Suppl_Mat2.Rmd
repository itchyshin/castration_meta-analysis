...
prep <- qdrg(object = pub_bias, data = data, at = list(Effective_N = 0, cYear = 0))
...
```{r}
# visualizing results
orchard_plot(mod_comp3b, mod = "Comp_type", xlab = "log response ratio (lnRR)", 
             group = "Study", data = sdat_long, angle = 45)
