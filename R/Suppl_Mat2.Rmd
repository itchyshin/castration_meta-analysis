...
```{r, eval = F}
# visualizing results
f1 <- orchard_plot(mod_comp2c, mod = "Comp_type", xlab = "log response ratio (lnRR)", group = "Study", data = sdat_long, angle = 90)
...
```{r, eval = F}
# visualizing results
f2 <- orchard_plot(mod_comp3b, mod = "Comp_type", xlab = "log response ratio (lnRR)", 
