...
r2_ml(mod_sham1)
# orchard plot
orchard_plot(mod_sham, mod = "Shamtreatment_moderator", xlab = "log response ratio (lnRR)", group = "Study", data = dat)
...
# Meta-regression: contrasting sexes {.tabset .tabset_fade .tabset_pills} 
